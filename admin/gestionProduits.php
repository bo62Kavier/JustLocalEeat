                ...
                <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="">
                    <div class="d-flex">
                        <div class="form-floating mb-3 me-3">
                            <input type="text" class="form-control" required name="titre" id="titre" placeholder="Nom du produit">
                            <label for="titre">Nom</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" required name="price" id="author" placeholder="Prix du produit">
                            <label for="price">Prix</label>
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="form-floating mb-3 me-3">
                            <input type="text" class="form-control" required name="Lprice" id="price" placeholder="Prix de livraison">
